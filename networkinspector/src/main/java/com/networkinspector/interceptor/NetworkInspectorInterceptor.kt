 ...
 * ## Configuration:
 * ```kotlin
 * val interceptor = NetworkInspectorInterceptor(
 *     maxContentLength = 500_000L,  // Max body size to capture
 *     headersToRedact = setOf("Authorization", "Cookie")  // Headers to hide
 * )
 * ```
 */
class NetworkInspectorInterceptor @JvmOverloads constructor(
    ...
    override fun intercept(chain: Interceptor.Chain): Response {
        ...
        // Track success or failure based on response code
